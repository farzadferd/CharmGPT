...
const Chat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-rose-950 flex flex-col">
      {/* Navigation */}
      <nav className="flex justify-between items-center p-4 border-b border-slate-700/50 backdrop-blur-sm bg-black/20">
        ...
        <div className="flex space-x-2">
          <Button onClick={newChat} variant="ghost" className="text-slate-300 hover:text-amber-300 hover:bg-amber-500/10 border border-slate-700/50 backdrop-blur-sm transition-all duration-300 rounded-xl">
      ...
      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full">
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 max-w-2xl">
                <div className="p-4 bg-slate-900/40 border border-slate-700/50 rounded-2xl backdrop-blur-sm">
              ...
              {isGenerating && (
                <div className="flex justify-start">
                  <div className="flex space-x-3 max-w-3xl">
                    ...
                    <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-700/50 backdrop-blur-sm">
        ...
        {/* Input Area */}
        <div className="p-4 border-t border-slate-700/50 backdrop-blur-sm bg-black/20">
          <div className="flex space-x-4 max-w-4xl">
            <Input
              ...
              className="bg-slate-900/50 border-slate-600/50 text-white placeholder:text-slate-500 rounded-xl focus:border-rose-400/50 focus:ring-rose-400/20 transition-all"
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-rose-500 via-pink-500 to-amber-500 hover:from-rose-600 hover:via-pink-600 hover:to-amber-600 rounded-xl px-6 transition-all duration-300 shadow-lg shadow-rose-500/25"
            >
          ...
          <div className="flex items-center justify-center mt-4 space-x-4">
            ...
            <ToggleGroup type="single" value={responseType} onValueChange={(value) => value && setResponseType(value)}>
              <ToggleGroupItem 
                value="flirty" 
                className="text-rose-400 data-[state=on]:bg-rose-500/20 data-[state=on]:text-rose-300 border border-slate-700/50 rounded-lg px-4 py-2 transition-all hover:bg-rose-500/10"
              >
                💕 Flirty
              </ToggleGroupItem>
              <ToggleGroupItem 
                value="witty" 
                className="text-amber-400 data-[state=on]:bg-amber-500/20 data-[state=on]:text-amber-300 border border-slate-700/50 rounded-lg px-4 py-2 transition-all hover:bg-amber-500/10"
              >
                ✨ Witty
              </ToggleGroupItem>
              <ToggleGroupItem 
                value="romantic" 
                className="text-pink-400 data-[state=on]:bg-pink-500/20 data-[state=on]:text-pink-300 border border-slate-700/50 rounded-lg px-4 py-2 transition-all hover:bg-pink-500/10"
              >
                💖 Romantic
              </ToggleGroupItem>
            </ToggleGroup>
